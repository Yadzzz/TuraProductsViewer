    ...
    public class SixPerPageLayout
    {
        ...
        private void Initialize()
        {
            ...
            foreach (var product in creatorService.GetProducts())
            {
                ...
                {
                    html += this.AddDataRow(this.languageVariables["frpstlvariable"], product.QtyPerUnitOfMeasure.ToString("F2") + " " + this.languageVariables["measurment"]);
                }
                ...
                if (creatorService.ShowInStock)
                {
                    ...
                    {
                        html += this.AddDataRow(this.languageVariables["ilagervariable"], product.AvailableQty > 0 ? product.AvailableQty.ToString() : this.languageVariables["no"]);
                    }
                    else
                    {
        ...
        private string AddDataRow(string variable, string data)
        {
            ...
            htmlData += variable;
            htmlData += "</div>";
            htmlData += "<div style='float:left; width:40%; margin-left:30px'>";
            htmlData += data;
            htmlData += "</div>";
