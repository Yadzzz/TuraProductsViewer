...
namespace TuraProductsViewer.HtmlDesigner.Layouts
{
    public class TenPerPageAdaptiveLayout
    {
        ...
        public TenPerPageAdaptiveLayout(CreatorService crtService, ImageService imgService, bool isHtml, string pageTitle, string language, Dictionary<string, string> languageVariables, string clickImgLink)
        {
        ...
        public MemoryStream InitializePDF()
        {
            ...
            foreach (var product in creatorService.GetProducts())
            {
                ...
                else if (this.creatorService.PriceType == PriceType.RekNetto)
                {
                    ...
                    htmlData += "<p><b>" + this.languageVariables["prisvariable"] + "</b>:" + this.creatorService.FinalizePrice(product) + ", <b>" +
